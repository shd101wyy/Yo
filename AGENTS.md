...
| `plans/PRE_P1_HANDOVER.md`                   | **Read before starting P1.** What must be true first (3 HOLLOW files, branch protection), the `ctl` ABI decision that expires with the TS referee, and three verified-false premises in P1's own plan         |
