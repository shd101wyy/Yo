...
| `plans/P1_CLI_PARITY.md`                     | **P1 handover — start here.** Where P1 stands, three verified-false premises in P1's own plan (`build` hollow, `doc` missing its render half, no `module_manager`), the suggested order, and the method notes |
