...
| `src/evaluator/values/*.ts`                         | `yo-self/evaluator/values/*.yo`                         | 🔄 In progress (clone_value.yo ✅, anonymous_struct.yo ✅, anonymous_module.yo ✅ Phase 3 done; anonymous_function.yo stub — Phase 3 work)                            |
