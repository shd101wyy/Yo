...
| `src/evaluator/values/*.ts`                         | `yo-self/evaluator/values/*.yo`                         | 🔄 In progress (clone_value.yo done; anonymous_struct.yo + anonymous_module.yo are Phase 3 stubs — Phase 2bl)                                                         |
