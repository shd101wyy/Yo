...
through resolvable callees (`function_reaches_non_send_global`, hooked into the spawn-boundary
capture check; pragma'd bodies trusted; unresolvable callees rejected), plus the `static mut`
