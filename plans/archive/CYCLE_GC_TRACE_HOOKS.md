> **CLOSED (2026-08-06).** All phases done. The doc's "only remaining item" (HashMap `Trace`) has since been implemented at `std/collections/hash_map.yo:746`.
...
`issues/fixed/yo-self-cycle-gc-runtime-port.md`.
