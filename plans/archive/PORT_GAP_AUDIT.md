...
2. **Typed-AST-gated** — the file would port mechanically but the
   ...
   the since-deleted untyped-codegen issue file; see `plans/archive/BOOTSTRAPPING_CODEGEN.md`)
