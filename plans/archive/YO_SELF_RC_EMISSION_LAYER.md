...
`plans/archive/YO_SELF_NAMED_LOCAL_DROPS.md` (its named-local-drop work IS Phase B). Original decisive
...
See `plans/archive/YO_SELF_NAMED_LOCAL_DROPS.md §6` (Probe A/B source, the 6 gates). Summary:
