...
Read `plans/archive/YO_SELF_STAGE2_HANDOFF.md` for the bootstrap campaign as a whole; this doc is
...
| 34–37 | Memory levers (RC header slimming, caller-frame sharing, `g_frame_indexes` diet, GC probe)                         | Parked at user direction. `plans/backlog/YO_SELF_ENV_SHARING.md` has the ranked list.                                                                                                                                                                                                                                                                                                                               |
| —     | `issues/fixed/module-global-c-names-are-not-namespaced.md`                                                         | Soundness hole: module globals get UNMANGLED C names, so same-named globals in different modules alias. Audited clean today (std 0, yo-self 181/181 distinct, tests 2/2) but nothing prevents the next collision.                                                                                                                                                                                                   |
| —     | `issues/retired/ctfe-elided-unit-call-arg-temp-leak.md`, `issues/fixed/fieldless-ref-enum-simple-enum-collapse.md` | Filed, unfixed, not CI-blocking. (`yo-self-tail-expression-arg-temp-drop-missing` was fixed 2026-08-06 — now in `issues/fixed/`.)                                                                                                                                                                                                                                                                                   |
