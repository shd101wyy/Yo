...
| —     | `issues/retired/ctfe-elided-unit-call-arg-temp-leak.md`, `issues/fieldless-ref-enum-simple-enum-collapse.md` | Filed, unfixed, not CI-blocking. (`yo-self-tail-expression-arg-temp-drop-missing` was fixed 2026-08-06 — now in `issues/fixed/`.)                                                                                                                                                                                                                                                                                   |
