...
[`LLM_FRIENDLY_TOOLCHAIN_AND_SYNTAX`](archive/LLM_FRIENDLY_TOOLCHAIN_AND_SYNTAX.md) and
[`PARALLELISM_SOUNDNESS`](archive/PARALLELISM_SOUNDNESS.md) (data-race freedom for safe code; its
rules live on in [`reference/PARALLELISM_RULES.md`](reference/PARALLELISM_RULES.md)).
