...
- [`DROP_LIBURING.md`](DROP_LIBURING.md) — drop the liburing library: vendor the io_uring ring layer into the emitted Linux runtime; phases keyed to one release's seed bump.
