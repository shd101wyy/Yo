...
syn keyword yoTypeName Type Module Trait Self This Dyn Impl Future Concrete Fn FnOnce IO Send Acyclic Comptime Runtime Copy Box Promise Array Slice Tuple Expr ComptimeList ExprList Result Impt unit
