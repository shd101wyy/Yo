...
- **Total: ~293 tests passing** under `yo-self/tests/`
...
yo-self/
  ...
  tests/
    ...
    codegen.test.yo   -- 68 codegen tests (Phases 4a–4e, 4i)
```
...
| 4     | C Codegen                                       | ~46 k lines       | 🔨 In progress (4a–4e, 4i) |
