> **FIXED — verified 2026-08-06** (the status header below is stale): both guards are present in src/codegen/exprs/while.ts:130/135 and yo-self/codegen/exprs/while_loop.yo (a8b77bd8a), with corpus test while_or_shortcircuit_owned_temp.yo.
