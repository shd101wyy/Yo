...
The plan (`plans/archive/YO_SELF_STAGE2_HANDOFF.md`, item 3) records the fixpoint
...
Reference: `plans/archive/YO_SELF_NAMED_LOCAL_DROPS.md` (M1/M2/M3 milestones); M3 is the
