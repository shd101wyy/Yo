...
**Generated 2026-09-14** over the 220 open docs in `issues/` root, as part of a
clean-up pass. This is a NAVIGATION aid, not a source of truth: each doc remains
...
1. **A doc's own `**Status:**` header is a claim, not a verdict.** This pass
   closed 20 docs whose headers already said FIXED — each verified against the
   tree first — and it also found headers that were simply out of date in the
   other direction. Treat the Status column as "what the doc says about
   itself".

2. **A repro that exits 0 has not necessarily passed.** Most repros here PRINT
   evidence and exit 0 regardless; the exit code says the program ran, not that
   the bug is gone. The `Repro` column records that a reproducer exists and was
   executed against a tree-built binary on 2026-09-14 — only the rows called
   out under **Confirmed still reproducing** had their OUTPUT adjudicated.

3. **An expected-value table inside a doc is also a claim.** Two were wrong
   this session (a weekday row, and a "largest valid code point"). Derive
   expectations independently before pinning them in a regression test —
   otherwise red-then-green certifies the wrong answer.
...
These are ready to be worked on — the defect was observed, not inferred.
...
- [`stddoc-io-arg-parser-positionals-are-never-required.md`](./stddoc-io-arg-parser-positionals-are-never-required.md) — missing required arg still parses `Ok`
...
compiler, or whose content is a TS-vs-self divergence, cannot be acted on and
should move to `retired/` after a read-through.
...
### Owned by the peer session (do not touch)

- [`a-while-in-a-match-arm-with-spawns-still-runs-zero-iterations.md`](./a-while-in-a-match-arm-with-spawns-still-runs-zero-iterations.md)
- [`dyn-selftrait-payload-never-matches-the-named-trait.md`](./dyn-selftrait-payload-never-matches-the-named-trait.md)
- [`error-source-result-cannot-be-held-as-anyerror.md`](./error-source-result-cannot-be-held-as-anyerror.md)
- [`self-trait-in-a-return-type-loses-the-trait-on-an-erased-receiver.md`](./self-trait-in-a-return-type-loses-the-trait-on-an-erased-receiver.md)
...
| [`error-source-result-cannot-be-held-as-anyerror.md`](./error-source-result-cannot-be-held-as-anyerror.md) **[PEER]** | OPEN — blocks `ErrorChain` / `root_cause` | yes |
| [`file-from-fd-metadata-stats-the-current-directory.md`](./file-from-fd-metadata-stats-the-current-directory.md) | OPEN | — |
| [`float-to-string-is-platform-dependent-for-non-finite-values.md`](./float-to-string-is-platform-dependent-for-non-finite-values.md) | OPEN | — |
...
| [`httpmethod-from-string-returns-option-not-result.md`](./httpmethod-from-string-returns-option-not-result.md) | OPEN | — |
| [`ipaddr-parse-v4-accepts-empty-octets-and-wraps-on-overflow.md`](./ipaddr-parse-v4-accepts-empty-octets-and-wraps-on-overflow.md) | OPEN | — |
| [`ipaddr-v6-to-string-is-not-rfc-5952-canonical.md`](./ipaddr-v6-to-string-is-not-rfc-5952-canonical.md) | OPEN | — |
...
| [`make-sockaddr-ignores-inet-pton-failure-and-returns-the-wildcard-address.md`](./make-sockaddr-ignores-inet-pton-failure-and-returns-the-wildcard-address.md) | OPEN | — |
...
| [`random-f64-single-flake-under-sweep.md`](./random-f64-single-flake-under-sweep.md) | OPEN (observation; 13 reruns clean) | — |
...
| [`std-imm-exports-nine-internal-node-types-nothing-can-use.md`](./std-imm-exports-nine-internal-node-types-nothing-can-use.md) | OPEN | yes |
...
| [`stddoc-io-ipv6-to-string-is-not-rfc-5952-canonical.md`](./stddoc-io-ipv6-to-string-is-not-rfc-5952-canonical.md) | open | yes |
...
| [`tempfile-dispose-and-file-pos-interaction.md`](./tempfile-dispose-and-file-pos-interaction.md) | OPEN | — |
...
| [`udpsocket-send-is-unreachable-without-a-connect-method.md`](./udpsocket-send-is-unreachable-without-a-connect-method.md) | OPEN | — |
...
| [`walker-follow-symlinks-windows-unsupported.md`](./walker-follow-symlinks-windows-unsupported.md) | OPEN | — |
...
| Doc | Status (self-reported) | Repro |
| --- | --- | --- |
| [`annotated-local-from-a-trait-constrained-receiver-loses-every-method.md`](./annotated-local-from-a-trait-constrained-receiver-loses-every-method.md) | OPEN | — |
| [`anonymous-module-trial-swallows-a-top-level-derive.md`](./anonymous-module-trial-swallows-a-top-level-derive.md) | OPEN | yes |
...
| [`calling-an-io-param-closure-in-a-generic-fn-keeps-an-unresolved-somet.md`](./calling-an-io-param-closure-in-a-generic-fn-keeps-an-unresolved-somet.md) | OPEN | yes |
| [`comments-preceding-definitions-can-hollow-the-definition.md`](./comments-preceding-definitions-can-hollow-the-definition.md) | OPEN | — |
| [`comptime-enum-payload-field-assignment-is-a-silent-no-op.md`](./comptime-enum-payload-field-assignment-is-a-silent-no-op.md) | OPEN | — |
...
| [`derived-eq-ref-enum-self-payload-hollow-at-runtime.md`](./derived-eq-ref-enum-self-payload-hollow-at-runtime.md) | OPEN (surfaced by the V5 task-6 verifier work | — |
...
| [`dyn-selftrait-payload-never-matches-the-named-trait.md`](./dyn-selftrait-payload-never-matches-the-named-trait.md) **[PEER]** | OPEN | — |
...
| [`equality-operator-without-an-eq-impl-evaluates-to-unit.md`](./equality-operator-without-an-eq-impl-evaluates-to-unit.md) | OPEN | — |
...
| [`generic-fn-specialized-at-two-types-hands-the-closure-the-wrong-param-type.md`](./generic-fn-specialized-at-two-types-hands-the-closure-the-wrong-param-type.md) | OPEN | yes |
| [`generic-fn-type-compatibility-is-not-alpha-equivalent.md`](./generic-fn-type-compatibility-is-not-alpha-equivalent.md) | OPEN | — |
...
| [`iterator-chain-shared-stamp-cross-item-pollution.md`](./iterator-chain-shared-stamp-cross-item-pollution.md) | OPEN | — |
...
| [`module-level-control-bound-binding-not-rejected.md`](./module-level-control-bound-binding-not-rejected.md) | OPEN | — |
| [`mutual-recursion-between-a-fn-and-a-trait-impl-body.md`](./mutual-recursion-between-a-fn-and-a-trait-impl-body.md) | OPEN | yes |
| [`same-operator-chain-of-four-or-more-is-not-left-associative.md`](./same-operator-chain-of-four-or-more-is-not-left-associative.md) | OPEN | — |
| [`self-trait-in-a-return-type-loses-the-trait-on-an-erased-receiver.md`](./self-trait-in-a-return-type-loses-the-trait-on-an-erased-receiver.md) **[PEER]** | OPEN | yes |
| [`unit-zst-residual-gaps.md`](./unit-zst-residual-gaps.md) | OPEN (deliberate scope boundary, not regressi | — |
| [`varbound-combinator-receiver-impl-match.md`](./varbound-combinator-receiver-impl-match.md) | PARTIALLY FIXED 2026-08-24 (branch s1-iterato | — |
| [`where-bound-gc-trace-still-fails-when-run-standalone.md`](./where-bound-gc-trace-still-fails-when-run-standalone.md) | OPEN | — |
...
| [`a-module-global-is-lost-across-an-async-suspension.md`](./a-module-global-is-lost-across-an-async-suspension.md) | OPEN | yes |
| [`a-ref-value-passed-to-an-async-future-is-never-released.md`](./a-ref-value-passed-to-an-async-future-is-never-released.md) | OPEN | yes |
| [`a-while-in-a-match-arm-with-spawns-still-runs-zero-iterations.md`](./a-while-in-a-match-arm-with-spawns-still-runs-zero-iterations.md) **[PEER]** | OPEN — a SECOND defect in the same family, NO | yes |
| [`async-abort-dispose-double-drops-moved-enum-payload.md`](./async-abort-dispose-double-drops-moved-enum-payload.md) | the binding pair is FIXED in TS (2026-08-11); | — |
| [`async-await-nested-if-lost-continuation.md`](./async-await-nested-if-lost-continuation.md) | — | — |
| [`async-capture-mode-argument-rendering-cluster.md`](./async-capture-mode-argument-rendering-cluster.md) | OPEN | — |
...
| [`async-cond-value-with-await-arm-inside-while-yields-zero.md`](./async-cond-value-with-await-arm-inside-while-yields-zero.md) | OPEN | — |
| [`async-cond-value-with-throwing-arm-after-await-undeclared-temp.md`](./async-cond-value-with-throwing-arm-after-await-undeclared-temp.md) | OPEN | — |
| [`async-effect-setter-emits-a-raw-non-ascii-identifier-as-a-c-member-name.md`](./async-effect-setter-emits-a-raw-non-ascii-identifier-as-a-c-member-name.md) | OPEN | — |
| [`async-nested-cond-await-duplicate-while-labels.md`](./async-nested-cond-await-duplicate-while-labels.md) | OPEN (unminimized) | — |
...
| [`closure-argument-inside-an-io-async-body-loses-the-future-result-type.md`](./closure-argument-inside-an-io-async-body-loses-the-future-result-type.md) | OPEN | yes |
| [`command-stdin-windows-pipe-write-blocks-the-event-loop.md`](./command-stdin-windows-pipe-write-blocks-the-event-loop.md) | OPEN | — |
...
| [`io-await-inside-a-macro-expansion-is-emitted-as-a-blocking-await.md`](./io-await-inside-a-macro-expansion-is-emitted-as-a-blocking-await.md) | OPEN | yes |
| [`io-await-on-a-join-handle-is-reported-as-an-internal-compiler-error.md`](./io-await-on-a-join-handle-is-reported-as-an-internal-compiler-error.md) | OPEN (filed 2026-09-13) | yes |
...
| [`sync-main-awaits-propagate-errors-through-a-null-exn.md`](./sync-main-awaits-propagate-errors-through-a-null-exn.md) | OPEN | — |
| [`unwind-from-a-handler-installed-inside-io-async-exits-main-with-rc-0.md`](./unwind-from-a-handler-installed-inside-io-async-exits-main-with-rc-0.md) | OPEN | yes |
...
| [`windows-async-io-runtime-audit.md`](./windows-async-io-runtime-audit.md) | OPEN (audit 2026-09-12, branch `audit/windows | — |
...
| [`yield-resumption-order-diverges-on-macos-ci.md`](./yield-resumption-order-diverges-on-macos-ci.md) | OPEN — observed TWICE on CI, on two DIFFERENT | — |
...
| [`assign-to-by-value-closure-param-under-generic-result-types-unit.md`](./assign-to-by-value-closure-param-under-generic-result-types-unit.md) | OPEN | yes |
...
| [`cinclude-int-comparison-fails-to-transpile.md`](./cinclude-int-comparison-fails-to-transpile.md) | OPEN (workaround in place) | — |
...
| [`emitted-c-hardcodes-linux-at-fdcwd.md`](./emitted-c-hardcodes-linux-at-fdcwd.md) | OPEN | — |
| [`emitted-c-include-order-differs-ts-vs-self.md`](./emitted-c-include-order-differs-ts-vs-self.md) | OPEN (cosmetic; 2026-08-10) | — |
| [`ftt-abort-stub-error-attribute-does-not-fire-above-optimize-0.md`](./ftt-abort-stub-error-attribute-does-not-fire-above-optimize-0.md) | OPEN | — |
| [`ftt-stub-in-live-closure-falls-off-non-void-function.md`](./ftt-stub-in-live-closure-falls-off-non-void-function.md) | PARTIALLY FIXED — still OPEN for the `unit`-r | yes |
...
| [`self-hosted-debug-emission-undeclared-temp.md`](./self-hosted-debug-emission-undeclared-temp.md) | OPEN | — |
...
| Doc | Status (self-reported) | Repro |
| --- | --- | --- |
| [`compiler-holds-emit-memory-during-cc.md`](./compiler-holds-emit-memory-during-cc.md) | OPEN — CONFIRMED TWICE, and now the sole caus | — |
| [`debug-probe-line-costs-gigabytes-at-compile-time.md`](./debug-probe-line-costs-gigabytes-at-compile-time.md) | OPEN (the probe is reverted; the underlying c | — |
| [`desugar-token-clones-evaluator-regression.md`](./desugar-token-clones-evaluator-regression.md) | — | — |
| [`self-hosted-emit-leaks-remaining-classes.md`](./self-hosted-emit-leaks-remaining-classes.md) | OPEN — the map for the next RC campaign | — |
...
| [`yo-self-async-completion-drop-set-divergence.md`](./yo-self-async-completion-drop-set-divergence.md) | OPEN | — |
...
| [`yo-self-compile-performance-rc-string-eq.md`](./yo-self-compile-performance-rc-string-eq.md) | DIAGNOSED 2026-07-23 (profile-verified) | — |
| [`yo-self-ctfe-nested-fn-analysis-gap.md`](./yo-self-ctfe-nested-fn-analysis-gap.md) | the reported bug is FIXED (2026-08-05) | — |
...
| [`yo-self-missing-duplicate-impl-checks.md`](./yo-self-missing-duplicate-impl-checks.md) | OPEN | — |
...
| [`yo-self-test-runner-cannot-run-wasm-batches.md`](./yo-self-test-runner-cannot-run-wasm-batches.md) | OPEN | — |
...
| [`yoself-accepts-await-in-cond-that-ts-rejects.md`](./yoself-accepts-await-in-cond-that-ts-rejects.md) | OPEN | — |
| [`yoself-missing-compiling-with-print.md`](./yoself-missing-compiling-with-print.md) | OPEN | — |
...
| [`fmt-not-idempotent-call-wrapped-match-in-block.md`](./fmt-not-idempotent-call-wrapped-match-in-block.md) | OPEN | yes |
...
| [`template-string-backslash-before-interpolation-eats-both.md`](./template-string-backslash-before-interpolation-eats-both.md) | OPEN | — |
| [`template-string-nested-inside-an-interpolation-fails-to-parse.md`](./template-string-nested-inside-an-interpolation-fails-to-parse.md) | OPEN | — |
| [`test-runner-std-path-shadowed-by-binary-tree-std.md`](./test-runner-std-path-shadowed-by-binary-tree-std.md) | OPEN | — |
...
| [`yo-fmt-walks-gitignored-generated-files.md`](./yo-fmt-walks-gitignored-generated-files.md) | OPEN | — |
...
| [`d6-schannel-hangs-the-windows-test-legs-for-four-hours.md`](./d6-schannel-hangs-the-windows-test-legs-for-four-hours.md) | OPEN — #413 REVERTED from develop 2026-09-06 | — |
...
| [`http-limits-test-depends-on-httpbin-org-inside-a-required-gate.md`](./http-limits-test-depends-on-httpbin-org-inside-a-required-gate.md) | OPEN | — |
...
| [`release-gate-accepts-a-docs-fast-path-run-as-proof-of-green.md`](./release-gate-accepts-a-docs-fast-path-run-as-proof-of-green.md) | OPEN | — |
...
| [`seed-early-return-drops-later-local-through-shadowing-pattern-name.md`](./seed-early-return-drops-later-local-through-shadowing-pattern-name.md) | OPEN (2026-09-07) | — |
| [`v0.2.23-seed-build-lottery-corrupts-shifted-trees.md`](./v0.2.23-seed-build-lottery-corrupts-shifted-trees.md) | OPEN | — |
| [`version-install-cross-device-link.md`](./version-install-cross-device-link.md) | OPEN | — |
