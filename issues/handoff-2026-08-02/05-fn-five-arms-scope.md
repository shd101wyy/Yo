...
1. `imm_map.test.yo` HOLLOW → **RED rc=134** — patch E, the already-documented `get_enum_variant_c_name` abort (`issues/yo-self-hollow-root-cause-map.md`, commit `10bca26bc`). Reproduces on HEAD alone; not created by E.
