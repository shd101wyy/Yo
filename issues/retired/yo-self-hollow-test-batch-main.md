...
- **Not a swallowed evaluator error.** An instrumented build printing `err` in
  ...
  `issues/retired/yo-self-stub-inventory.md` — but removing them did not change the
  marker count.)
...
(`issues/retired/yo-self-69-red-list-map.md`: impl*fn_field_rejection /
...
(issues/retired/yo-self-69-red-list-map.md, "GATE RESULT: the closure registry stamp
