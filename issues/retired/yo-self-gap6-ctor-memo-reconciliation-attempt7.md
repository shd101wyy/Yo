> **RETIRED (2026-08-06).** Superseded record — attempt ledger premised on red imm/rc/arc families; superseded by the creation-side memoization fix and the 186/186-green suite.
...
issues/fixed/yo-self-comptime-int-forall-inference.md); thread/worker ADVANCED
