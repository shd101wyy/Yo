> **RETIRED (2026-08-06).** Superseded record — OS/toolchain snapshot; superseded by `--disable-sanitize` + the asanRuntimeIsUsable probe (src/yo-cli.ts), with Linux CI supplying real ASan coverage.
