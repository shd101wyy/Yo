        ...
        if (
          ...
          if (exprIsAtom(methodExpr)) {
            ...
            if (isStaticMethodCall) {
              ...
              // `unsafe(...)` (plans/POINTER_OPERATORS_TO_TRAITS_AND_METHODS.md
...
`,
  ...
  if (
    ...
    // Migration-helper mode (plans/EXTERN_UNSAFE_WRAP.md Phase C):
