...
export interface CapturedVariable {
   ...
   */
  isHoldingTheSameRcValueAs: CapturedVariable | undefined;
}
        ...
        if (variables.length > 0) {
          ...
          if (
            ...
            if (variable.isHoldingTheSameRcValueAs) {
              const ownerVar = variable.isHoldingTheSameRcValueAs;
        ...
        if (futureType && futureType.tag === TypeTag.Future) {
          ...
          if (
            ...
            if (futureVariables.length > 0) {
              ...
              if (futureVar.isHoldingTheSameRcValueAs) {
                futureVariableId = futureVar.isHoldingTheSameRcValueAs.id;
              } else {
