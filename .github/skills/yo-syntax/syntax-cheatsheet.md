...
- Name what you import. `{ ... } :: import("std/module")` is the glob form for the rare file that wants every export; there is NO `open(...)` builtin (removed 2026-09-09)
...
| Derive traits              | `derive(MyType, Eq(MyType), Ord(MyType), Hash, Clone, ToString, Default)`          | [DERIVE_TRAITS.md](https://github.com/shd101wyy/Yo/blob/develop/docs/en-US/DERIVE_TRAITS.md)                           |
